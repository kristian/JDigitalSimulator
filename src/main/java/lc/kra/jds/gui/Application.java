...
public class Application extends JFrame {
    ...
    private static final String[]
            TOOLBAR_FRAME_FOCUS = new String[]{"save", "print", "print_level", "simulate", "analyse", "left", "right", "up", "down", "grid", "secure", "zoom_default", "zoom", "zoom_in", "zoom_out"},
    ...
    public Application() {
        ...
        componentButtons = new Vector<ComponentButton>();
        collapsiblePanels = new Vector<CollapsiblePanel>();
...
//        } else this.setExtendedState(MAXIMIZED_BOTH);
        ...
        this.addWindowListener(new WindowAdapter() {
            @Override
            public void windowClosing(WindowEvent event) { exitApplication(); }
        });
    ...
    private void loadComponents(URL ressource, String checkPackage) {
        if (ressource.getProtocol().equals("jar"))
            try {
                loadComponents(new JarFile(Utilities.getFile(ressource)), checkPackage);
            } catch (Throwable t) {
            }
    ...
    private void loadComponents(File likelyFile, String checkPackage, String currentPackage) {
        if (likelyFile.isDirectory())
            ...
            loadComponents(new JarFile(likelyFile), checkPackage);
        } catch (Throwable t) {
            try {
                loadComponent(likelyFile.getName(), checkPackage, currentPackage);
            } catch (Throwable t_a) {
                try {
                    loadComponent(Utilities.getSimpleClassLoader().loadClass(likelyFile));
                } catch (Throwable t_b) {
                } //that was our last trick... nothing to do here anymore
            }
        }
    }
    ...
    private void loadComponents(final JarFile file, String checkPackage) {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            try {
                loadComponent(entry.getName(), checkPackage);
            } catch (Throwable t) {
                try {
                    loadComponent(Utilities.getSimpleClassLoader().loadClass(file, entry));
                } catch (Throwable t_a) {
                } //that was our last trick... nothing to do here anymore
            }
        }
    ...
    private boolean loadComponent(Class<?> cls) {
        ...
        try {
            componentCls = (Class<? extends Component>) cls;
    ...
    private SimulationDesktop createDesktopPanel() {
        ...
        desktop.addContainerListener(new ContainerListener() {
            @Override
            public void componentRemoved(ContainerEvent event) { revalidate(); }

            @Override
            public void componentAdded(ContainerEvent event) { revalidate(); }
        });
        return desktop;
    }
    ...
    private JMenuBar createMenuBar() {
        ...
        file.add(createMenuItem("file.new", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) { newWorksheet(); }
        }));
        file.add(createMenuItem("file.open", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) { openWorksheet(); }
        }));
        ...
        file.add(createMenuItem("file.save", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) { saveWorksheet(); }
        }));
        file.add(createMenuItem("file.save_as", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) { saveWorksheetAs(); }
        }));
        file.add(new JSeparator());
        file.add(createMenuItem("file.print", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) { printWorksheet(); }
        }));
        file.add(createMenuItem("file.print_level", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) { printWorksheetLevel(); }
        }));
        file.add(new JSeparator());
        file.add(createMenuItem("file.exit", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) { exitApplication(); }
        }));
        menubar.add(file);
        ...
        edit.add(createMenuItem("edit.cut", new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                try {
                    getActiveSimulation().cutIntoClipboard();
        ...
        edit.add(createMenuItem("edit.copy", new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                try {
                    getActiveSimulation().copyToClipboard();
                } catch (CloneNotSupportedException e) {
                }
                revalidate();
            }
        ...
        edit.add(createMenuItem("edit.paste", new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                try {
                    getActiveSimulation().pasteFromClipboard();
                } catch (CloneNotSupportedException e) {
                }
                revalidate();
            }
        ...
        properties.add(createMenuItem("properties.worksheet", new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                bottomPane.add(Guitilities.createButton(getTranslation("properties.secure"), new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent event) { getToolBarButton("secure").getActionListeners()[0].actionPerformed(event); }
                }));
                bottomPane.add(new JSeparator(JSeparator.VERTICAL));
                final ActionListener cancelListener = new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent event) { dialog.dispose(); }
        ...
        window.add(createMenuItem("window.cascade", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) { desktop.cascadeAllFrames(); }
        }));
        window.add(createMenuItem("window.tile", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) { desktop.tileAllFrames(); }
        }));
        menubar.add(window);
        ...
        help.add(createMenuItem("help.about", new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                bottomPane.add(Guitilities.createButton(getTranslation("about.donate"), new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent event) { labelUrl.getMouseListeners()[0].mouseClicked(null); }
                }));
...
//                }
    ...
    private JFileChooser getFileChooser() {
        ...
        chooser.setFileFilter(new FileFilter() {
            @Override
            public String getDescription() { return getTranslation("persist.filter.description"); }

            @Override
            public boolean accept(File file) { return file.isDirectory() || file.getName().toLowerCase().endsWith('.' + FILE_EXTENSION); }
        });
        return chooser;
    }
    ...
    public void addWorksheet(final SimulationFrame frame) {
        ...
        frame.addInternalFrameListener(new InternalFrameAdapter() {
            @Override
            public void internalFrameOpened(InternalFrameEvent event) { revalidate(); }

            @Override
            public void internalFrameActivated(InternalFrameEvent event) { revalidate(); }

            @Override
            public void internalFrameDeactivated(InternalFrameEvent event) { revalidate(); }

            @Override
            public void internalFrameClosed(InternalFrameEvent event) { revalidate(); }
        });
        desktop.add(frame);
            ...
            setTransferHandler(new TransferHandler("digital-simulator-component") {
                ...
                protected Transferable createTransferable(JComponent component) {
                    return new Transferable() {
                        @Override
                        public boolean isDataFlavorSupported(DataFlavor flavor) { return flavor instanceof ComponentFlavor; }

                        @Override
                        public DataFlavor[] getTransferDataFlavors() { return new DataFlavor[]{ComponentFlavor.getFlavor()}; }
                ...
                @Override
                public int getSourceActions(JComponent component) { return TransferHandler.COPY; }
            });
    ...
    public static class SimulationDesktop extends JDesktopPane {
        ...
        @Override
        protected void addImpl(java.awt.Component component, Object obj, int layer) {
        ...
        @Override
        public SimulationFrame selectFrame(boolean flag) { return (SimulationFrame) super.selectFrame(flag); }

        @Override
        public SimulationFrame getSelectedFrame() { return (SimulationFrame) super.getSelectedFrame(); }

        @Override
        public SimulationFrame[] getAllFrames() { return cast(super.getAllFrames()); }

        @Override
        public SimulationFrame[] getAllFramesInLayer(int layer) { return cast(super.getAllFramesInLayer(layer)); }
    ...
    public class SimulationFrame extends JInternalFrame implements Printable {
        ...
        public SimulationFrame(InputStream in) throws IOException, GeneralSecurityException {
            try {
                try {
                    simulation = Simulation.readSimulation(in);
                } catch (PasswordRequiredException e) {
        ...
        private void initialize() {
                        ...
                        if (hasChanged())
                            switch (JOptionPane.showConfirmDialog(Application.this, getTranslation("persist.changes", getFileName()), getTranslation("persist.changes", TranslationType.TITLE), JOptionPane.YES_NO_CANCEL_OPTION)) {
                                ...
                                case JOptionPane.CANCEL_OPTION:
                                    throw new PropertyVetoException(new String(), event);
                            }
                }
            });
            ...
            simulation.addFocusListener(new FocusListener() {
                @Override
                public void focusLost(FocusEvent event) { focusGained(event); }
            ...
            simulation.addChangeListener(new Simulation.ChangeListener() {
                @Override
                public void changed(ChangeEvent event) { setChanged(true); }
            });
                        ...
                        switch (event.getKeyCode()) {
                            case KeyEvent.VK_O:
                                if (event.isAltDown() && event.isShiftDown()) {
                                    ...
                                    chooser.setFileFilter(new FileFilter() {
                                        @Override
                                        public String getDescription() { return "Class (*.class), Jar-File (*.jar)"; }
        ...
        @Override
        public int print(Graphics default_graphics, PageFormat pageFormat, int pageNumber) throws PrinterException {
            if (simulation.print(default_graphics, pageFormat, pageNumber) != NO_SUCH_PAGE) {
                ...
                graphics.setFont(default_graphics.getFont().deriveFont(Font.BOLD, 14));
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 0)
            try {
                application.openWorksheet(new File(args[0]));
            } catch (Exception e) {
