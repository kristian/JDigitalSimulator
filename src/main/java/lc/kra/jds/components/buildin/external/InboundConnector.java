...
/**
 * Inbound Connector (build-in component)
 * @author Kristian Kraljic (kris@kra.lc)
 */
public class InboundConnector extends Connector {
	private static final long serialVersionUID = 1l;

	private static final String KEY;
	static { KEY = "component.external."+InboundConnector.class.getSimpleName().toLowerCase(); }
	...
	public boolean isCharged() { return output.isCharged(); }
	public void setCharged() { output.setCharged(); }
	public void setCharged(boolean charged) { output.setCharged(charged);	}
