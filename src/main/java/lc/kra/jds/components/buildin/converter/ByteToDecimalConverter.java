...
/**
 * Byte-to-Decimal-Converter (build-in component)
...
public class ByteToDecimalConverter extends Component implements Sociable {
	...
	static { KEY = "component.converter."+ByteToDecimalConverter.class.getSimpleName().toLowerCase(); }
	...
	@Override public void calculate() {
		...
		outputs[number].setCharged(true);
	}
}